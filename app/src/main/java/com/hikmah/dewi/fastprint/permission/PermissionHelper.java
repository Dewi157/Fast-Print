package com.hikmah.dewi.fastprint.permission;
...
public class PermissionHelper {
    ...
    public boolean checkAndRequestPermissions() {//1. Call this to check permission. (Call this affected loop for check permission until user Approved it)
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            int reedstorage = ContextCompat.checkSelfPermission(mActivity, Manifest.permission.READ_EXTERNAL_STORAGE);
            int writestorage = ContextCompat.checkSelfPermission(mActivity, Manifest.permission.READ_EXTERNAL_STORAGE);
            ...
            if (reedstorage != PackageManager.PERMISSION_GRANTED) {
